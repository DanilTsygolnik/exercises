...
class TestEx_5(unittest.TestCase):
    ...
    def test_SynchronizingTables(self):
        ...
        self.assertEqual(ex_5_sol.SynchronizingTables(3, [50, 1, 1024], [20000, 100000, 90000]), [90000, 20000, 100000])

        N = int(random.randint(1, 50))
        val = get_values(N)
        self.assertEqual(ex_5_sol.SynchronizingTables(N, val['ids'], val['sal mess']), val['sal'])
