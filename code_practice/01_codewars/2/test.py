...
from sol import expression_matter
...
class TestExpressoinsMatter(unittest.TestCase):
    
    def test_codewars_task(self):
        self.assertEqual(expression_matter(2, 1, 2), 6)
        self.assertEqual(expression_matter(2, 1, 1), 4)
        self.assertEqual(expression_matter(2, 2, 4), 16)
        self.assertEqual(expression_matter(3, 3, 3), 27)
